...
- MBE = mean bias error (mm/day) - average error from PT and HS methods minus PM;</li>
- MAE = mean absolute error (mm/day);</li>
- RMSE = root mean square error (mm/day);</li>
- OLS = ordinary least squares regression;</li>
